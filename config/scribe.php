...
use Knuckles\Scribe\Config\{AuthIn, Defaults};
...
return [
    ...
    'auth' => [
        ...
        'extra_info' => 'You can obtain your token by logging in through the <code>POST api/v1/auth/login</code> endpoint. The token must be sent in the Authorization header as <code>Bearer {token}</code>.',
    ],

...
class ModuleEventListener extends GeneratorCommand
{
    ...
    protected $signature = 'module:event-listener
                            {name : Nome do modelo para o qual o listener será gerado com base no template}
    ...
    public function handle()
    {
        ...
        if ($this->alreadyExists($this->getNameInput())) {
            ...
            if ($this->option('force')) {
                $this->info('Sobrescrevendo Event Listener existente...');
    ...
    {
        $stubPath = app_path() . '/Console/Commands/Modules/Stubs/ModuleEventListener.stub';
